...
import com.classroom.telus.international.dsu.javacollections.bo.TreeMapExample;
...
public class TreeMapView {
     ...
     public static void main(String[] args) {
        ...
        TreeMapExample varLinkedHashMap = new TreeMapExample();
        int option;
        int index;
        do {
            Animal animal;
            ...
            switch (option) {
                ...
                default:
               System.out.println("exiting TreeMap");
